<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gradebook.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
               ...
               <div class="MenuBar_Layout_Div">
                ...
                <table cellspacing="0" >
                   ...
                   <div class="Contents_Proper_Div">
                       <br />
                     <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="0" EnableTheming="True" Paddings-PaddingLeft="10px" RenderMode="Lightweight" Theme="Default" Width="750px">
                           <TabPages>
                                  ...
                                  <td>
                                       ...
                                       <tr style="background-color:#808080;height:40px;">
                                                        <td style="width:200px;padding-left:10px;text-align:center;">
                                                           <asp:Label ID="Label25" runat="server" Text="Course Title"></asp:Label>
                                                        </td>
                                            ...
                                            <ItemTemplate>
                                                <table style="width:700px;" cellspacing="0">
                                                   <tr>
                                                    ...
                                                    <tr>
                                                        <td style="width:200px;padding-left:10px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text='<%#Eval("course_code")%>' Theme="DevEx"></dx:ASPxLabel>
