                ...
                <table cellspacing="0" >
                    ...
                    <tr>
                        <td>                          
                            ...
                            <a href="smessages.aspx" style="text-decoration:none"><div class="MenuBar_Sub_Div"><br />Messages</div></a>
                   ...
                   <table class="insert-form">
                          <tbody style="margin:0px;">
                            ...
                            <tr>
                            <td>                                                                
                                <dx:ASPxLabel ID="lblEmployeeCodebel" runat="server" Text="Student Info" Theme="DevEx" Font-Bold="true" Font-Size="Medium"></dx:ASPxLabel>
                            </td>
                            </tr>
                            <tr>
                            <td>
                            ...
                            <td align="left" style=" font-weight:bold; font-size:12pt;font-family:Arial Narrow;">
                                <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Roll No :" Theme="DevEx" Font-Bold="True" Font-Size="Small"></dx:ASPxLabel><br/>
                                <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Program :" Theme="DevEx" Font-Bold="True" Font-Size="Small"></dx:ASPxLabel><br/>
                                <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Session :" Theme="DevEx" Font-Bold="True" Font-Size="Small"></dx:ASPxLabel><br/>
                                <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="Registration Date :" Theme="DevEx" Font-Bold="True" Font-Size="Small"></dx:ASPxLabel><br/>
                                
                            </td>
                                 <td align="left" style="font-family:Arial Narrow;font-size:12pt;">
                                      <dx:ASPxLabel ID="ASPxLabel17" runat="server" Text='<%#Eval("rollno")%>' Theme="DevEx"></dx:ASPxLabel><br/>
                                      <dx:ASPxLabel ID="ASPxLabel18" runat="server" Text='<%#Eval("program_id")%>' Theme="DevEx"></dx:ASPxLabel><br/>
                                      <dx:ASPxLabel ID="ASPxLabel19" runat="server" Text='<%#Eval("session_id")%>' Theme="DevEx"></dx:ASPxLabel><br/>
                                      <dx:ASPxLabel ID="ASPxLabel20" runat="server" Text='<%#Eval("reg_date","{0:d}")%>' Theme="DevEx"></dx:ASPxLabel><br/>
                    ...
                    <tr>
                        <td>
                            <dx:ASPxLabel ID="ASPxLabel16" runat="server" Text="Personal Info" Theme="DevEx" Font-Bold="true" Font-Size="Medium"></dx:ASPxLabel>
                            </td>
                        </tr>

                                <tr>
                                   <td align="left" style=" font-weight:bold; font-size:12pt;font-family:Arial Narrow;">
                                       <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="Name :" Theme="DevEx" Font-Bold="True" Font-Size="Small"></dx:ASPxLabel><br/>
                                       <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text="Gender :" Theme="DevEx" Font-Bold="True" Font-Size="Small"></dx:ASPxLabel><br/>
                                       <dx:ASPxLabel ID="ASPxLabel7" runat="server" Text="CNIC :" Theme="DevEx" Font-Bold="True" Font-Size="Small"></dx:ASPxLabel><br/>
                                       <dx:ASPxLabel ID="ASPxLabel8" runat="server" Text="Mobile No :" Theme="DevEx" Font-Bold="True" Font-Size="Small"></dx:ASPxLabel><br/>
                                       <dx:ASPxLabel ID="ASPxLabel9" runat="server" Text="Current Address :" Theme="DevEx" Font-Bold="True" Font-Size="Small"></dx:ASPxLabel><br/>
                                       <dx:ASPxLabel ID="ASPxLabel10" runat="server" Text="Email :" Theme="DevEx" Font-Bold="True" Font-Size="Small"></dx:ASPxLabel><br/>
                                
                            </td>
                                 <td align="left" style="font-family:Arial Narrow;font-size:12pt;">
                                      <dx:ASPxLabel ID="ASPxLabel21" runat="server" Text='<%#Eval("name")%>' Theme="DevEx"></dx:ASPxLabel><br/>
                                      <dx:ASPxLabel ID="ASPxLabel22" runat="server" Text='<%#Eval("gender")%>' Theme="DevEx"></dx:ASPxLabel><br/>
                                      <dx:ASPxLabel ID="ASPxLabel23" runat="server" Text='<%#Eval("nic")%>' Theme="DevEx"></dx:ASPxLabel><br/>
                                      <dx:ASPxLabel ID="ASPxLabel24" runat="server" Text='<%#Eval("mobile")%>' Theme="DevEx"></dx:ASPxLabel><br/>
                                      <dx:ASPxLabel ID="ASPxLabel25" runat="server" Text='<%#Eval("c_address")%>' Theme="DevEx"></dx:ASPxLabel><br/>
                                      <dx:ASPxLabel ID="ASPxLabel26" runat="server" Text='<%#Eval("email")%>' Theme="DevEx"></dx:ASPxLabel><br/>
                                
                                </td>

                                    <td align="left" style=" font-weight:bold; font-size:12pt;font-family:Arial Narrow;">
                                        <dx:ASPxLabel ID="ASPxLabel11" runat="server" Text="Father Name :" Theme="DevEx" Font-Bold="True" Font-Size="Small"></dx:ASPxLabel><br/>
                                        <dx:ASPxLabel ID="ASPxLabel12" runat="server" Text="Date of Birth :" Theme="DevEx" Font-Bold="True" Font-Size="Small"></dx:ASPxLabel><br/>
                                        <dx:ASPxLabel ID="ASPxLabel13" runat="server" Text="Nationality :" Theme="DevEx" Font-Bold="True" Font-Size="Small"></dx:ASPxLabel><br/>
                                        <dx:ASPxLabel ID="ASPxLabel14" runat="server" Text="Phone No :" Theme="DevEx" Font-Bold="True" Font-Size="Small"></dx:ASPxLabel><br/>
                                        <dx:ASPxLabel ID="ASPxLabel15" runat="server" Text="Permanent Address :" Theme="DevEx" Font-Bold="True" Font-Size="Small"></dx:ASPxLabel><br/>
