<%@ Page Language="C#" AutoEventWireup="true" CodeFile="quizess.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                                   ...
                                   <table style="height:30px;">
                                                    <tr>
                                                        <td style="width:100px;padding-left:10px;">
                                                            <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Quiz Name" Theme="DevEx"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:100px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Quiz Type" Theme="DevEx"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:100px;padding-left:10px;">
                                                            <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Quiz Level" Theme="DevEx"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:140px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="Quiz Topic" Theme="DevEx"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:80px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="Start Time" Theme="DevEx"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:80px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text="End Time" Theme="DevEx"></dx:ASPxLabel>
                               ...
                               <ContentTemplate>
                                <asp:GridView ID="dgquiz" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333" ShowHeader="False">
                                    ...
                                    <Columns>
                                                 ...
                                                 <table>
                                                    <tr>
                                                        <td style="width:100px;height:30px;padding-left:10px;">
                                                            <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text='<%#Eval("quiz_name")%>' Theme="DevEx"></dx:ASPxLabel>                                                                
                                                           
                                                        </td>
                                                        
                                                         <td style="width:100px;height:30px;text-align:center;">
                                                             <dx:ASPxLabel ID="ASPxLabel7" runat="server" Text='<%#Eval("quiz_type")%>' Theme="DevEx"></dx:ASPxLabel>                                                                
                                                            
                                                         </td>

                                                        <td style="width:100px;height:30px;padding-left:10px;">
                                                            <dx:ASPxLabel ID="ASPxLabel8" runat="server" Text='<%#Eval("quiz_level")%>' Theme="DevEx"></dx:ASPxLabel>                                                                
                                                           
                                                        </td>
                                                        
                                                         <td style="width:150px;height:30px;text-align:center;">
                                                             <dx:ASPxLabel ID="ASPxLabel9" runat="server" Text='<%#Eval("topic")%>' Theme="DevEx"></dx:ASPxLabel>                                                                
                                                            
                                                         </td>

                                                         <td style="width:80px;height:30px;text-align:center">
                                                             <dx:ASPxLabel ID="ASPxLabel10" runat="server" Text='<%#Eval("quiz_start_date","{0:d}")%>' Theme="DevEx"></dx:ASPxLabel>                                                                
                                                            
                                                         </td>

                                                        <td style="width:80px;height:30px;text-align:center"> 
                                                            <dx:ASPxLabel ID="ASPxLabel11" runat="server" Text='<%#Eval("quiz_end_date","{0:d}")%>' Theme="DevEx"></dx:ASPxLabel>                                                               
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnstart" CommandArgument='<%#Eval("id") + ";" + Eval("quiz_type") + ";" +Eval("quiz_level")%>' OnClick="btnstart_Click1" CausesValidation="false" runat="server">Start Quiz</asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
