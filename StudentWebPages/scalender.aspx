<%@ Page Language="C#" AutoEventWireup="true" CodeFile="scalender.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
               ...
               <div class="MenuBar_Layout_Div">
                ...
                <table cellspacing="0" >
                   ...
                   <div class="Contents_Proper_Div">
                       ...
                       <dx:ASPxCalendar ID="ASPxCalendar1" runat="server" DayNameFormat="Full" Theme="DevEx" Width="700px">
                       </dx:ASPxCalendar>
