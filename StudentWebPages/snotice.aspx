<%@ Page Language="C#" AutoEventWireup="true" CodeFile="snotice.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                   ...
                   <div class="Contents_Proper_Div">
                     <table class="insert-form">
                          ...
                          <tbody style="margin:0px;">
                              <tr>
                                  <td>
                                       ...
                                       <tr style="background-color:#808080;height:40px;">
                                                        <td style="padding-left:120px; width:150px; text-align:center;" class="auto-style3">
                                                            <dx:ASPxLabel ID="ASPxLabel16" runat="server" Text="Notice ID" Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="padding-left:100px; width:150px; text-align:center;" class="auto-style4">
                                                            <dx:ASPxLabel ID="ASPxLabel26" runat="server" Text="Notice Title" Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                         <td style="padding-left:130px;width:150px; text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text="Date" Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>                                          
                                                        
                                                         <td style="padding-left:135px;width:150px; text-align:center;">
                                                             
                                                             <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Detail" Theme="DevEx"></dx:ASPxLabel>
                                                         </td>                                          
                            ...
                            <asp:GridView ID="dgnotice" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333" ShowHeader="False">
                                                   ...
                                                   <tr>
                                                    ...
                                                    <tr>
                                                        <td style="width:350px;padding-left:10px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text='<%#Eval("notice_id")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:150px;padding-left:10px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text='<%#Eval("title")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:350px;padding-left:10px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text='<%#Eval("insert_date","{0:d}")%>' Theme="DevEx"></dx:ASPxLabel>
                                                    ...
                                                    <tr style="background-color:#f6f5f5;width:740px;">
                                                        ...
                                                        <td style="width:120px;height:30px;padding-left:10px; text-align:left">
                                                            <dx:ASPxLabel ID="ASPxLabel22" runat="server" Text="Notice Detailed :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                        ...
                                                        <td style="width:700px;height:30px;padding-left:10px;">
                                                          <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text='<%#Eval("description")%>' Theme="DevEx"></dx:ASPxLabel>  
