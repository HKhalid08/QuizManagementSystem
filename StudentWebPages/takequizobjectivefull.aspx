<%@ Page Language="C#" AutoEventWireup="true" CodeFile="takequizobjectivefull.aspx.cs" Inherits="Login_Login" %>
...
<body style="background-color:#ecf0f1;">
 ...
 <table style="width:600px;height:120px;background-color:#0094ff;border-radius:10px;">
     <tr>
         <td valign="middle" align="right" class="auto-style28">
     ...
     <tr>
         <td align="right" class="auto-style28" valign="middle"><span style="font-family:Arial;font-size:14px;color:white;">&nbsp;<dx:ASPxLabel ID="lbltype0" runat="server" ForeColor="White" Text="Quiz Level :" Theme="DevEx">
             </dx:ASPxLabel>
             </span></td>
         <td class="auto-style29">
         ...
         <td align="right" class="auto-style30"><span style="font-family:Arial;font-size:14px;color:white;">&nbsp;<dx:ASPxLabel ID="lbltotal" runat="server" ForeColor="White" Text="Total Marks :" Theme="DevEx">
             </dx:ASPxLabel>
             </span></td>
         <td>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>--%>
                                                <table style="width:580px; height:250px">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="lblquesno" runat="server" ForeColor="#999999" Font-Size="14pt" Font-Names="arial"></asp:Label>
                                                            &nbsp;:
                                                            <asp:Label ID="lblQuestionNumber" runat="server" Font-Names="arial" Font-Size="14" ForeColor="#999999" Text=""></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height:20px;">
