<%@ Page Language="C#" AutoEventWireup="true" CodeFile="takequizsubjectivefull.aspx.cs" Inherits="Login_Login" %>
                                                ...
                                                <table style="width:580px; height:250px">
                                                    ...
                                                    <tr>
                                                        <td style="height:20px;">
                                                            ...
                                                            <asp:Label ID="lblanswer" runat="server" Font-Names="arial" Font-Size="14pt" ForeColor="#999999">Answer :</asp:Label>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:TextBox ID="txtanswer" runat="server" Height="100px" TextMode="MultiLine" Width="500px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="height:20px;">
