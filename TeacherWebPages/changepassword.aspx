<%@ Page Language="C#" AutoEventWireup="true" CodeFile="changepassword.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                           ...
                           <tbody style="margin:0px;">
                               ...
                               <tr style="margin-top:-10px;padding-top:-10px">
                                   <td colspan:4 style="padding:0px 0px 0px 0px; margin:0px 0px 0px 0px">
                                       ...
                                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Change Password :" Theme="DevEx">
                                       </dx:ASPxLabel>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="User Name :" Theme="DevEx">
                                        </dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                        <dx:ASPxTextBox ID="txtusername" runat="server" Theme="DevEx" Width="170px" ReadOnly="True">
                                        </dx:ASPxTextBox>
                                   </td>
                                   <td class="auto-style3">
                                        &nbsp;</td>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Old Password :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                        <dx:ASPxTextBox ID="txtoldpassword" runat="server" Width="170px" Theme="DevEx" Password="True">
                                        </dx:ASPxTextBox>
                                   </td>
                                   <td class="auto-style3">
                                        &nbsp;</td>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                       <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="New Password :" Theme="DevEx">
                                       </dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                       <dx:ASPxTextBox ID="txtnewpassword" runat="server" Theme="DevEx" Width="170px" Password="True">
                                       </dx:ASPxTextBox>
                                   </td>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                       <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text="Confirm Password :" Theme="DevEx">
                                       </dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                       <dx:ASPxTextBox ID="txtconfirmpassword" runat="server" Theme="DevEx" Width="170px" Password="True">
                                       </dx:ASPxTextBox>
                                   </td>
                                   <td class="auto-style3">
                                       <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtnewpassword" ControlToValidate="txtconfirmpassword" ErrorMessage="Password Not-Matched" ForeColor="Red"></asp:CompareValidator>
                                   </td>
                                   <td class="auto-style3">&nbsp;</td>
                               </tr>
                               <tr>
                       ...
                       <table>
                           <tr>
                               ...
                               <td style="width:65px">
                                   <dx:ASPxButton ID="BtnClear" runat="server" Text="Clear" Theme="DevEx" style="height: 22px" OnClick="BtnClear_Click"></dx:ASPxButton>
                                   </td>
                               <td style="width:272px">
                                   </td>
                               </tr>
