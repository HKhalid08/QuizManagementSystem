<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lectureschedule.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                   ...
                   <br />
                    ...
                    <table class="insert-form">
                          <tbody style="margin:0px;">
                              <tr>
                                  <td>
                                    <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true" HasToggleGroupTreeButton="False" Height="50px" ToolPanelView="None" ToolPanelWidth="200px" Width="350px" />
                                 </td>
                              </tr>
                          </tbody>
                    </table>   
