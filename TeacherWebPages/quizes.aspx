<%@ Page Language="C#" AutoEventWireup="true" CodeFile="quizes.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                ...
                <table cellspacing="0" >
                   ...
                   <div class="Contents_Proper_Div">
                     <div class="Contents_Link_View">
                           ...
                           <a class="Contents_Link_Anchor" href="quizsetting.aspx" style="text-decoration:none" id="View_Tooltip" tooltip="Quiz Setting Here">&nbsp;&nbsp;&nbsp;<strong>Quiz Setting</strong></a>
                       ...
                       <div class="Contents_Link_New">
                           ...
                           <a class="Contents_Link_Anchor" href="addquizes.aspx" style="text-decoration:none" id="New_Tooltip" tooltip="Add New Quiz Here">&nbsp;&nbsp;&nbsp;<strong>Add Quiz</strong></a>
