<%@ Page Language="C#" AutoEventWireup="true" CodeFile="quizsetting.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                     ...
                     <table class="insert-form">
                           <tbody style="margin:0px;">
                               ...
                               <tr style="margin-top:-10px;padding-top:-10px">
                                   <td colspan:4 style="padding:0px 0px 0px 0px; text-align:center; margin:0px 0px 0px 0px">
                                       ...
                                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Quiz Setting" Theme="DevEx">
                                       </dx:ASPxLabel>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel11" runat="server" Text="Quiz Type :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td>
                                       <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                              <ContentTemplate>
                                        <dx:ASPxComboBox ID="cbquiztype" runat="server" Theme="DevEx" NullText="--Select--" AutoPostBack="True" OnSelectedIndexChanged="cbquiztype_SelectedIndexChanged">
                                            <Items>
                                   ...
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="lblEmployeeCodebel" runat="server" Text="Quiz Name :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td>
                                        <dx:ASPxTextBox ID="txtquizname" runat="server" Theme="DevEx" Width="170px">
                                       </dx:ASPxTextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtquizname" ErrorMessage="Enter Quiz Name" ForeColor="Red"></asp:RequiredFieldValidator>
                                   </td>
                                   <td>
                                        &nbsp;</td>
                               </tr>
                               ...
                               <tr>
                                   ...
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="lbllevel" runat="server" Text="Quiz Level :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td>
                                       <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                            <ContentTemplate>
                                        <dx:ASPxComboBox ID="cbquizlevel" runat="server" Theme="DevEx" NullText="--Select--" AutoPostBack="True" OnSelectedIndexChanged="cbquizlevel_SelectedIndexChanged">
                                            <Items>
                                                <dx:ListEditItem Text="Topic base" Value="Topic base" />
                                                <dx:ListEditItem Text="Subject base" Value="Subject base" />
                                            </Items>
                                        </dx:ASPxComboBox>
                                                 </ContentTemplate>
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="cbquiztype" EventName="SelectedIndexChanged" />
                                            </Triggers>
                                        </asp:UpdatePanel>
                                   </td>
                                   <td style="height:20px;width:150px;text-align:right;">
                                   ...
                                   <td>
                                       <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                        <dx:ASPxTextBox ID="txttopic" runat="server" Theme="DevEx" Width="170px" AutoPostBack="True" HelpText="Hint : Topic1-Topic2">
                                            <HelpTextSettings DisplayMode="Popup">
                                            </HelpTextSettings>
                                       </dx:ASPxTextBox>
                                                </ContentTemplate>
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="cbquizlevel" EventName="SelectedIndexChanged" />
                                            </Triggers>
                                        </asp:UpdatePanel>
                                   </td>
                                   <td>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="lblEmployeeCodebel0" runat="server" Text="No. of Questions :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td>
                                        <dx:ASPxTextBox ID="txtnoofquestion" runat="server" Theme="DevEx" Width="170px">
                                   ...
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Quiz Time :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td>
                                        <dx:ASPxTextBox ID="txtquiztime" runat="server" Theme="DevEx" Width="170px">
                                            <ValidationSettings CausesValidation="True" ErrorDisplayMode="ImageWithTooltip" ValidationGroup="validate_group">
                                                <RequiredField ErrorText="" IsRequired="True" />
                                            </ValidationSettings>
                                       </dx:ASPxTextBox>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtquiztime" ErrorMessage="NumericValue" ForeColor="Red" ValidationExpression="^[0-9]+$"></asp:RegularExpressionValidator>
                                   </td>
                                   <td>
                                        &nbsp;</td>
                               </tr>
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="lblEmployeeCodebel2" runat="server" Text="Total Marks :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td>
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txttotalmarks" ErrorMessage="NumericValue" ForeColor="Red" ValidationExpression="^[0-9]+$"></asp:RegularExpressionValidator>
                                   </td>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="lblEmployeeCodebel3" runat="server" Text="Passing Marks :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td>
                                        <dx:ASPxTextBox ID="txtpassingmarks" runat="server" Theme="DevEx" Width="170px">
                                            <ValidationSettings CausesValidation="True" ErrorDisplayMode="ImageWithTooltip" ValidationGroup="validate_group">
                                                <RequiredField ErrorText="" IsRequired="True" />
                                            </ValidationSettings>
                                       </dx:ASPxTextBox>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtpassingmarks" ErrorMessage="NumericValue" ForeColor="Red" ValidationExpression="^[0-9]+$"></asp:RegularExpressionValidator>
                                   </td>
                                   <td>
                                        &nbsp;</td>
                               </tr>
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Quiz Start Date :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td>
                                        <dx:ASPxDateEdit ID="dtquizstart" runat="server" Theme="DevEx">
                                        </dx:ASPxDateEdit>
                                   </td>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel12" runat="server" Text="Quiz End Date :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td>
                                       <dx:ASPxDateEdit ID="dtquizend" runat="server" Theme="DevEx">
                                       </dx:ASPxDateEdit>
                                   </td>
                                   <td>
                                       &nbsp;</td>
                       ...
                       <table>
                           <tr>
                               ...
                               <td style="width:65px">
                                   <dx:ASPxButton ID="BtnNew" runat="server" Text="New" Theme="DevEx" OnClick="BtnNew_Click" style="height: 23px"></dx:ASPxButton>
                                   </td>
                               <td style="width:65px">
