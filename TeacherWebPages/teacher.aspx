<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teacher.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            ...
                                            <table>
                                                ...
                                                <td>
                                                    <div style="float:left;width:80px;height:50px;text-align:center;">
                                                        <img src="../Website_Images/add question.jpg" width="20" height="20>"
                                                            <br />
                                                        <br />
                                                        <asp:LinkButton ID="btnaddquestion" OnClick="btnaddquestion_Click" CommandArgument='<%#Eval("course_code") + ";" +Eval("course")%>'  runat="server">Add Question</asp:LinkButton>
                                                    </div>
                                                </td>
                                                    ...
                                                    <td style="padding-left:25px;">
                                                        ...
                                                        <div style="float:left;width:80px;height:50px;text-align:center;">
                                                        <img src="../Website_Images/View.jpg" width="20" height="20" />
<br />
                                                          
                                                        <asp:LinkButton ID="btnviewquestion" OnClick="btnviewquestion_Click" CommandArgument='<%#Eval("course_code") + ";" +Eval("course")%>'  runat="server">View Question</asp:LinkButton>
                                                    ...
                                                    <td style="padding-left:25px;">
                                                     ...
                                                     <div style="float:right;width:90px;height:50px;text-align:center;">
                                                          <img src="../Website_Images/Settings.png" width="20" height="20" />
                                                         <br />
                                                         <asp:LinkButton ID="btnquizsetting" OnClick="btnquizsetting_Click" CommandArgument='<%#Eval("course_code") + ";" +Eval("course")%>'  runat="server">Quiz Setting</asp:LinkButton>
                                                    </div>
                                                
                                                 </td>
                                                    <td style="padding-left:25px;">
                                                    
                                                        <div style="float:left;width:90px;height:50px;text-align:center;">
                                                             <img src="../Website_Images/Add-Assignment.jpg" width="20" height="20>"
                                                            <br />
                                                        <br />
                                                             <asp:LinkButton ID="btnaddassignment" OnClick="btnaddassignment_Click" CommandArgument='<%#Eval("course_code") + ";" +Eval("course")%>'  runat="server">Add Assignment</asp:LinkButton>
                                                        </div>
                                                    ...
                                                    <td style="padding-left:25px;">
                                                        ...
                                                        <div style="float:left;width:100px;height:50px;text-align:center;">
                                                                 <img src="../Website_Images/View.jpg" width="20" height="20" />
<br />
                                                             <asp:LinkButton ID="btnviewassignment" OnClick="btnviewassignment_Click" CommandArgument='<%#Eval("course_code") + ";" +Eval("course")%>'  runat="server">View Assignment</asp:LinkButton>
                                                        </div>
                                                    ...
                                                    <td style="padding-left:25px;">
                                                     ...
                                                     <div style="float:right;width:90px;height:50px;text-align:center;">
                                                         <img src="../Website_Images/btn_courses.png" width="20" height="20" />
                                                         <br />
