<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tmessages.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                     ...
                     <table style="height:80px;">
                       ...
                       <br />
                       <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="1" EnableTheming="True" RenderMode="Lightweight" Theme="Default" Width="750px">
                           <TabPages>
                               <dx:TabPage Name="Quizzes" Text="Quizzes">
                                   <ContentCollection>
                          ...
                          <tbody style="margin:0px;">
                                  ...
                                  <td>
                                       ...
                                       <tr style="background-color:#808080;height:40px;">
                                                        ...
                                                        <td style="width:100px;padding-left:10px;text-align:center;">
                                                           <asp:Label ID="Label26" runat="server" Text="Quiz Name"></asp:Label>
                                                        </td>
                                                        <td style="width:100px;padding-left:10px;text-align:center;">
                                                           <asp:Label ID="Label27" runat="server" Text="Course Code"></asp:Label>
                                                        </td>
                                                        <td style="width:100px;padding-left:10px;text-align:center;">
                            ...
                            <asp:GridView ID="dgquiz" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333" ShowHeader="False">
                                                ...
                                                <table style="width:700px;" cellspacing="0">
                                                   <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:100px;padding-left:10px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text='<%#Eval("quiz_name")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:100px;padding-left:10px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text='<%#Eval("course_code")%>' Theme="DevEx"></dx:ASPxLabel>
                                                    ...
                                                    <tr style="background-color:#f6f5f5;width:740px;">
                                                        ...
                                                        <table class='<%#Eval("Id")%>' hidden>
                                                            <tr>
                                                        <td style="width:60px;height:30px;padding-left:10px;">
                                                            <dx:ASPxLabel ID="ASPxLabel22" runat="server" Text="Question :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:350px;">
                                                            <dx:ASPxLabel ID="ASPxLabel13" runat="server" Text='<%#Eval("question")%>' Theme="DevEx"></dx:ASPxLabel>
                                                        ...
                                                        <td style="width:60px;padding-left:10px;">
                                                            <dx:ASPxLabel ID="ASPxLabel17" runat="server" Text="Answer :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:350px;">
                                                            <dx:ASPxLabel ID="ASPxLabel15" runat="server" Text='<%#Eval("correct_answer")%>' Theme="DevEx"></dx:ASPxLabel>
                               ...
                               <dx:TabPage Name="Assignments" Text="Assignments">
                                   <ContentCollection>
                                       <dx:ContentControl ID="ContentControl2" runat="server" SupportsDisabledAttribute="True">
                                           <asp:GridView ID="dgassignment" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333">
                            ...
                            <tr>
                            <td style="width:100px;height:30px;padding-left:10px;">                                                                
                               ...
                               <%--<asp:Label ID="Label3" runat="server" Text='<%#Eval("assignment_name") %>'></asp:Label>--%>
                                    <asp:LinkButton ID="AssignDownload" CausesValidation="false" Text="Solution File" CommandArgument='<%# Eval("assignment_path") %>' runat="server" OnClick="AssignDownload_Click"></asp:LinkButton>
                            </td>
                             
                                <td style="width:220px;height:30px;text-align:center">                                                                
                               <asp:Label ID="Label6" runat="server" Text='<%#Eval("insert_date","{0:D}") %>'></asp:Label>
                            </td>
                            </tr>
