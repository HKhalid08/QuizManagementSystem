<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tnotifications.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                   ...
                   <div class="Contents_Proper_Div">
                    <table class="insert-form">
                          ...
                          <tbody style="margin:0px;">
                              <tr>
                                  <td>
                                       ...
                                       <tr style="background-color:#808080;height:40px;">
                                                        <td style="padding-left:100px;" class="auto-style3">
                                                            <dx:ASPxLabel ID="ASPxLabel16" runat="server" Text="Notification ID" Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="padding-left:20px;" class="auto-style4">
                                                            <dx:ASPxLabel ID="ASPxLabel26" runat="server" Text="Notification Title" Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                         <td style="padding-left:70px;text-align:left;">
                            ...
                            <asp:GridView ID="dgtnotification" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333" ShowHeader="False">
                                                   ...
                                                   <tr>
                                                    ...
                                                    <tr>
                                                        <td style="width:350px;padding-left:10px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text='<%#Eval("notification_id")%>' Theme="DevEx"></dx:ASPxLabel>
