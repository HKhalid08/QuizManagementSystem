<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewassignment.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                       ...
                       <table class="insert-form">
                          <tbody style="margin:0px;">
                            ...
                            <td style="width:100px;height:30px;padding-left:10px;">                                                                
                               ...
                               <asp:Label ID="Label2" runat="server" Text='<%#Eval("lesson") %>'></asp:Label>
                            </td>
                               ...
                               <asp:Label ID="Label4" runat="server" Text='<%#Eval("total_marks") %>'></asp:Label>
                                 ...
                                 <td style="width:120px;height:30px;text-align:center">                                                                
                               <asp:Label ID="Label5" runat="server" Text='<%#Eval("due_date") %>'></asp:Label>
                            </td>
                                <td style="width:120px;height:30px;text-align:center">                                                                
                               <asp:Label ID="Label6" runat="server" Text='<%#Eval("insert_date") %>'></asp:Label>
                            </td>
                            </tr>
