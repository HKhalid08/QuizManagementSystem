<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewquestion.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                   ...
                   <div class="Contents_Proper_Div" style="overflow:scroll;">
                       <table class="insert-form">
                          <tbody style="margin:0px;">
                              <tr>
                                  ...
                                  <td>
                                        ...
                                        <dx:ASPxTextBox ID="txtcoursetitle" runat="server" Theme="DevEx" Width="200px" ReadOnly="True" Height="19px">
                                       </dx:ASPxTextBox>
                          ...
                          <tbody style="margin:0px;">
                                  ...
                                  <td>
                                       ...
                                       <tr style="background-color:#808080;height:40px;">
                                                        <td style="width:20px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel16" runat="server" Text="Questions" Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:30px;padding-left:10px;text-align:left;">
                                                            <dx:ASPxLabel ID="ASPxLabel26" runat="server" Text="Correct Answer" Theme="DevEx"></dx:ASPxLabel>
                            ...
                            <asp:GridView ID="dgquestion" runat="server" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333" ShowHeader="False" OnPageIndexChanging="dgquestion_PageIndexChanging">
                                    ...
                                    <Columns>                                           
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <table style="width:730px;" cellspacing="0">
                                                   <tr>
                                                        <td style="height:5px;">
                                                    ...
                                                    <tr>
                                                        <td style="width:350px;padding-left:10px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text='<%#Eval("question")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:150px;padding-left:10px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text='<%#Eval("correct_answer")%>' Theme="DevEx"></dx:ASPxLabel>
                                                    ...
                                                    <tr style="background-color:#f6f5f5;width:740px;">
                                                        ...
                                                        <td style="width:120px;height:30px;padding-left:10px; text-align:right">
                                                            <dx:ASPxLabel ID="ASPxLabel22" runat="server" Text="A :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:120px;">
                                                            <dx:ASPxLabel ID="ASPxLabel13" runat="server" Text='<%#Eval("answer_a")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:100px; text-align:right">
                                                            <dx:ASPxLabel ID="ASPxLabel16" runat="server" Text="B :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:100px;">
                                                            <dx:ASPxLabel ID="ASPxLabel14" runat="server" Text='<%#Eval("answer_b")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                                </tr>
                                                        <tr>
                                                        <td style="width:120px;height:30px;padding-left:10px;text-align:right">
                                                            <dx:ASPxLabel ID="ASPxLabel17" runat="server" Text="C :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td>
                                                            <dx:ASPxLabel ID="ASPxLabel15" runat="server" Text='<%#Eval("answer_c")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                                <td style="width:95px; text-align:right">
                                                            <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="D :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td>
                                                            <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text='<%#Eval("answer_d")%>' Theme="DevEx"></dx:ASPxLabel>
