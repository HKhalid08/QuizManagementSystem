<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addnotifications.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                           ...
                           <tbody style="margin:0px;">
                               ...
                               <tr style="margin-top:-10px;padding-top:-10px">
                                   <td colspan:4 style="padding:0px 0px 0px 0px; margin:0px 0px 0px 0px">
                                       ...
                                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Notifications :" Theme="DevEx">
                                       </dx:ASPxLabel>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="lblEmployeeCodebel" runat="server" Text="Notification ID :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                        <dx:ASPxTextBox ID="txtnotificationid" runat="server" Theme="DevEx" Width="170px">
                                   ...
                                   <td class="auto-style3">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtnotificationid" ErrorMessage="Enter Notification ID" ForeColor="Red"></asp:RequiredFieldValidator>
                                   </td>
                                   <td class="auto-style3">
                                        &nbsp;</td>
                               </tr>
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Notification Title :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                        <dx:ASPxTextBox ID="txttitle" runat="server" Width="170px" Theme="DevEx">
                                            <ValidationSettings CausesValidation="True" ErrorDisplayMode="ImageWithTooltip" ValidationGroup="validate_group">
                                                <RequiredField ErrorText="" IsRequired="True" />
                                            </ValidationSettings>
                                        </dx:ASPxTextBox>
                                   ...
                                   <td class="auto-style3">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txttitle" ErrorMessage="Enter NotificationTitle" ForeColor="Red"></asp:RequiredFieldValidator>
                                   </td>
                                   <td class="auto-style3">
                                        &nbsp;</td>
                               </tr>
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Description :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
