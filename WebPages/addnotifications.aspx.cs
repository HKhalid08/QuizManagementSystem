...
public partial class Web_Pages_PortoQuiz_Home : System.Web.UI.Page
{
    ...
    public void Clear()
    {
        txtnotificationid.Text = string.Empty;
    ...
    public void InsertNotification()
    {
        ...
        objbll.Notification_id = txtnotificationid.Text;
        objbll.Title = txttitle.Text;
        objbll.Description = txtdescription.Text;
        objbll.Createdby = user;
        objbll.Modifiedby = user;
        int a = objbll.InsertNotification(objbll);
        if (a == 1)
        {
            lblresult.Text = "Notification save Successfully....";
