<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addschedule.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                           ...
                           <tbody style="margin:0px;">
                               ...
                               <tr style="margin-top:-10px;padding-top:-10px">
                                   <td colspan:4 style="padding:0px 0px 0px 0px; margin:0px 0px 0px 0px">
                                       ...
                                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Schedule :" Theme="DevEx">
                                       </dx:ASPxLabel>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="Session ID :" Theme="DevEx">
                                        </dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                        <dx:ASPxComboBox ID="cbsession" runat="server" Theme="DevEx" ValueType="System.String" NullText="--Select--">
                                        </dx:ASPxComboBox>
                                   </td>
                                   <td class="auto-style3">
                                        &nbsp;</td>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Employee Code :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                       <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                              <ContentTemplate>
                                        <dx:ASPxComboBox ID="cbemployeecode" runat="server" Theme="DevEx" ValueType="System.String" NullText="--Select--" OnSelectedIndexChanged="cbemployeecode_SelectedIndexChanged" AutoPostBack="True">
                                        </dx:ASPxComboBox>
                                                  </ContentTemplate>
                                          </asp:UpdatePanel>
                                   </td>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="Employee Name :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                       <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                            <ContentTemplate>
                                        <dx:ASPxTextBox ID="txtname" runat="server" Width="170px" Theme="DevEx" AutoPostBack="True">
                                        </dx:ASPxTextBox>
                                                </ContentTemplate>
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="cbemployeecode" EventName="SelectedIndexChanged" />
                                            </Triggers>
                                        </asp:UpdatePanel>
                                   </td>
                                   <td class="auto-style3">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtname" ErrorMessage="Select Employee Code First" ForeColor="Red"></asp:RequiredFieldValidator>
                                   </td>
                                   <td class="auto-style3">
                                        &nbsp;</td>
                               </tr>
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel7" runat="server" Text="Course Name :" Theme="DevEx">
                                        </dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                        <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                              <ContentTemplate>
                                        <dx:ASPxComboBox ID="cbcoursename" runat="server" NullText="--Select--" Theme="DevEx" ValueType="System.String" AutoPostBack="True" OnSelectedIndexChanged="cbcoursename_SelectedIndexChanged">
                                        </dx:ASPxComboBox>
                                                  </ContentTemplate>
                                          </asp:UpdatePanel>
                                   </td>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text="Course Code :" Theme="DevEx">
                                        </dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                       <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                            <ContentTemplate>
                                                <dx:ASPxTextBox ID="txtcoursecode" runat="server" AutoPostBack="True" Theme="DevEx" Width="170px">
                                                </dx:ASPxTextBox>
                                            </ContentTemplate>
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="cbcoursename" EventName="SelectedIndexChanged" />
                                            </Triggers>
                                        </asp:UpdatePanel>
                                   </td>
                                   <td class="auto-style3">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtcoursecode" ErrorMessage="Select Course Name" ForeColor="Red"></asp:RequiredFieldValidator>
                                   </td>
                                   <td class="auto-style3">
                                        &nbsp;</td>
                               </tr>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel8" runat="server" Text="Day :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                        <dx:ASPxComboBox ID="cbday" runat="server" NullText="--Select--" Theme="DevEx">
                                            <Items>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel9" runat="server" Text="Time From :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                        <dx:ASPxTimeEdit ID="timefrom" runat="server">
                                        </dx:ASPxTimeEdit>
                                   </td>
                                   <td class="auto-style3">
                                        &nbsp;</td>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel10" runat="server" Text="Time To :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                        <dx:ASPxTimeEdit ID="timeto" runat="server">
                                        </dx:ASPxTimeEdit>
                                   </td>
                                   <td class="auto-style3">
                                        &nbsp;</td>
