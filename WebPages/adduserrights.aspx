<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adduserrights.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                           ...
                           <tbody style="margin:0px;">
                               ...
                               <tr style="margin-top:-10px;padding-top:-10px">
                                   <td colspan:4 style="padding:0px 0px 0px 0px; margin:0px 0px 0px 0px">
                                       ...
                                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="User Rights :" Theme="DevEx">
                                       </dx:ASPxLabel>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="Employee Code :" Theme="DevEx">
                                        </dx:ASPxLabel>
                                   </td>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        &nbsp;</td>
                                   <td class="auto-style3">
                                        <asp:GridView ID="dgrights" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                                            <AlternatingRowStyle BackColor="White" />
                                            <Columns>
                                                <asp:BoundField DataField="App_detail" HeaderText="App Name" />
                                                <asp:TemplateField HeaderText="Rights" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="50px">
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chrights" runat="server"></asp:CheckBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Add" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="50px">
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chadd" runat="server"></asp:CheckBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Visible" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="50px">
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chvisible" runat="server"></asp:CheckBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Update" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="50px">
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chupdate" runat="server"></asp:CheckBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="50px">
                                                    <ItemTemplate>
                                                        <asp:CheckBox ID="chdelete" runat="server"></asp:CheckBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
