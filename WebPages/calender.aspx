<%@ Page Language="C#" AutoEventWireup="true" CodeFile="calender.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                   ...
                   <div class="Contents_Proper_Div">
                     <table class="insert-form">
                          <tbody style="margin:0px;">
                              <tr>
                                  <td>
                        <dx:ASPxCalendar ID="ASPxCalendar1" runat="server" Theme="DevEx"></dx:ASPxCalendar>
                                      </td>
                                  </tr>
                          </tbody>
                          </table>  
