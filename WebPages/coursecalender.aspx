<%@ Page Language="C#" AutoEventWireup="true" CodeFile="coursecalender.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
...
<script type='text/javascript' language='javascript'>
    function AddNewRecord()
    {
        ...
        var grd = document.getElementById('dglecture');
                        ...
                        <table class="insert-form">
                          <tbody style="margin:0px;">
                              ...
                              <tr>
                                ...
                                <asp:GridView ID="dglecture" runat="server" AutoGenerateColumns="False" ShowFooter="true" GridLines="None" CellPadding="4" ForeColor="#333333" OnSelectedIndexChanging="dglecture_SelectedIndexChanging">
                                        ...
                                        <asp:TemplateField>
                                          <FooterTemplate>
                                           ...
                                           <asp:TemplateField HeaderText="Topic">
                                              <ItemTemplate>
                                                 <asp:TextBox ID="txt_topic" Text='<%# Eval("topic") %>' runat="server"></asp:TextBox>
                                              </ItemTemplate> 
                                           </asp:TemplateField>
                                           <asp:TemplateField HeaderText="Lecture">
                                               <ItemTemplate>
                                                  <asp:TextBox ID="txt_lecture" Text='<%# Eval("lecture") %>' runat="server"></asp:TextBox>
                                               </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Resource">
                                               <ItemTemplate>
                                              <asp:TextBox ID="txt_resources" Text='<%# Eval("resource") %>' runat="server"></asp:TextBox>
                                           </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
