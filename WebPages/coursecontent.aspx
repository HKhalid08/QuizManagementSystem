<%@ Page Language="C#" AutoEventWireup="true" CodeFile="coursecontent.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                           ...
                           <tbody style="margin:0px;">
                               ...
                               <tr style="margin-top:-10px;padding-top:-10px">
                                   <td colspan:4 style="padding:0px 0px 0px 0px; margin:0px 0px 0px 0px">
                                       ...
                                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Courses Contents :" Theme="DevEx">
                                       </dx:ASPxLabel>
                               ...
                               <tr>
                                   ...
                                   <td class="auto-style3">
                                       <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                              <ContentTemplate>
                                        <dx:ASPxComboBox ID="cbcourses" runat="server" Theme="DevEx" ValueType="System.String" OnSelectedIndexChanged="cbcourses_SelectedIndexChanged" AutoPostBack="True">
                                        </dx:ASPxComboBox>
                                                 </ContentTemplate>
                                          </asp:UpdatePanel>
                                   </td>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                       <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="Course Content :" Theme="DevEx">
                                       </dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                      <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                            <ContentTemplate>
                                       <asp:TextBox ID="txtcontent" runat="server" Height="100px" TextMode="MultiLine" Width="450px" AutoPostBack="True"></asp:TextBox>
                                              </ContentTemplate>
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="cbcourses" EventName="SelectedIndexChanged" />
                                            </Triggers>
                                        </asp:UpdatePanel>
                                   </td>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Course Synopsis :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                        <asp:TextBox ID="txtsynopsis" runat="server" Height="100px" TextMode="MultiLine" Width="450px"></asp:TextBox>
                                   </td>
                                   <td class="auto-style3">
                                        &nbsp;</td>
                                   <td class="auto-style3">
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="Learning Outcomes :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                        <asp:TextBox ID="txtlearning" runat="server" Height="100px" TextMode="MultiLine" Width="450px"></asp:TextBox>
