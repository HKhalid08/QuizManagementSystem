<%@ Page Language="C#" AutoEventWireup="true" CodeFile="courses.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                ...
                <table cellspacing="0" >
                   ...
                   <div class="Contents_Proper_Div">
                       <div class="Contents_Link_View">
                           ...
                           <a class="Contents_Link_Anchor" href="viewcourses.aspx" style="text-decoration:none" id="View_Tooltip" tooltip="You Can (Edit or Delete) Courses Here">&nbsp;&nbsp;&nbsp;<strong>View Courses</strong></a>
                       ...
                       <div class="Contents_Link_New">
                           ...
                           <a class="Contents_Link_Anchor" href="addcourses.aspx" style="text-decoration:none" id="New_Tooltip" tooltip="Add Courses Here">&nbsp;&nbsp;&nbsp;<strong>Add Courses</strong></a>
                       ...
                       <div class="Contents_Link_Deleted">
                           ...
                           <a class="Contents_Link_Anchor" href="coursecontent.aspx" style="text-decoration:none" id="Deleted_Tootip" tooltip="Course Contents Here">&nbsp;&nbsp;&nbsp;<strong>Course Contents</strong></a>
                       ...
                       <div class="Contents_Link_Deleted">
                           ...
                           <a class="Contents_Link_Anchor"  href="coursecalender.aspx" style="text-decoration:none" id="Div4" tooltip="Course Calender Here">&nbsp;&nbsp;&nbsp;<strong>Course Calender</strong></a>
