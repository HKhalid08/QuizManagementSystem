<%@ Page Language="C#" AutoEventWireup="true" CodeFile="employee.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                ...
                <table cellspacing="0" >
                   ...
                   <div class="Contents_Proper_Div">
                       ...
                       <div class="Contents_Link_View">
                           ...
                           <a class="Contents_Link_Anchor" href="viewemployeeinfo.aspx" style="text-decoration:none" id="View_Tooltip" tooltip="You Can (Edit or Delete) Employee Here">&nbsp;&nbsp;&nbsp;<strong>View Employee</strong></a>
                       ...
                       <div class="Contents_Link_New">
                           ...
                           <a class="Contents_Link_Anchor" href="employeeinfo.aspx" style="text-decoration:none" id="New_Tooltip" tooltip="Add New Employee Information Here">&nbsp;&nbsp;&nbsp;<strong>New Employee</strong></a>
