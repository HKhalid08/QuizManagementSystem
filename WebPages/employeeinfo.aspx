<%@ Page Language="C#" AutoEventWireup="true" CodeFile="employeeinfo.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                           ...
                           <tbody style="margin:0px;">
                               ...
                               <tr style="margin-top:-10px;padding-top:-10px">
                                   <td colspan:4 style="padding:0px 0px 0px 0px; margin:0px 0px 0px 0px">
                                       ...
                                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Employee Info" Theme="DevEx">
                                       </dx:ASPxLabel>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="lblEmployeeCodebel" runat="server" Text="Employee Code :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td colspan="2">
                                        <dx:ASPxTextBox ID="txtemployeecode" runat="server" Theme="DevEx" Width="170px" ReadOnly="True">
                                       </dx:ASPxTextBox>
                                   </td>
                                   <td></td>
                                   <td rowspan="4" colspan="3">
                                     ...
                                     <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                         ...
                                         <ContentTemplate>
                                             <dx:ASPxImage ID="imgEmployeeBox" runat="server" Height="100px" Width="100px" ShowLoadingImage="True">
                                                 
                                                 
                                                 <EmptyImage Url="~/Record_Images/Admin.jpg">
                                                 </EmptyImage>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Departmant :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td colspan="2">
                                        <dx:ASPxComboBox ID="cmdDepartmants" runat="server" ValueType="System.String" Theme="DevEx" NullText="--Select--"></dx:ASPxComboBox>
                                   </td>
                                   <td></td>
                                   <td></td>
                               </tr>
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Designation :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td colspan="2">
                                        <dx:ASPxComboBox ID="cmbDesignation" runat="server" ValueType="System.String" Theme="DevEx" NullText="--Select--"></dx:ASPxComboBox>
                                   </td>
                                   <td></td>
                                   <td></td>
                               </tr>
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="Joining Date :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td colspan="2">
                                        <dx:ASPxDateEdit ID="dateJoing" runat="server" Theme="DevEx"></dx:ASPxDateEdit>
                                   </td>
                                   <td></td>
                                   <td></td>
                               </tr>
                                ...
                                <tr>
                                   <td>
                                    ...
                                    <td colspan="2">
                                     ...
                                     <td colspan="3">
                                        <dx:ASPxUploadControl ID="Btnbrowse" Width="170px" UploadMode="Auto" runat="server" NullText="Choose" OnFileUploadComplete="Btnbrowse_FileUploadComplete" ShowProgressPanel="True" ShowUploadButton="True"></dx:ASPxUploadControl>
                                   </td>
                               </tr>
                               ...
                               <tr>
                                ...
                                <tr>
                                   ...
                                   <td colspan="3">
                                       <dx:ASPxDateEdit ID="dtdob" runat="server" Theme="DevEx" NullText="--Select--">
                                       </dx:ASPxDateEdit>
                                    </td>
                               </tr>
                                <tr>
                                ...
                                <tr>
                                   ...
                                   <td>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtmobileno" ErrorMessage="NumericValue " ForeColor="Red" ValidationExpression="^[0-9]+$"></asp:RegularExpressionValidator>
                                   </td>
                                   <td style="height:20px;width:150px;text-align:right;">
                                   ...
                                   <td colspan="3">
                                    ...
                                    <td>
                                        &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtphoneno" ErrorMessage="NumericValue " ForeColor="Red" ValidationExpression="^[0-9]+$"></asp:RegularExpressionValidator>
&nbsp;</td>
                               </tr>
                               </tbody>
                           <caption>
                               ...
                               <tr>
                                   ...
                                   <tr>
                                       <td style="height:20px;width:150px;text-align:right;">
                                           <dx:ASPxLabel ID="ASPxLabel9" runat="server" Text="Current Address :" Theme="DevEx">
                                           </dx:ASPxLabel>
                                       </td>
                                       <td>
                                           <dx:ASPxTextBox ID="txtcaddress" runat="server" Theme="DevEx" Width="170px">
                                           </dx:ASPxTextBox>
                                       </td>
                                       <td>
                                   ...
                                   <tr>
                                       <td style="height:20px;width:150px;text-align:right;">
                                           <dx:ASPxLabel ID="lblemail" runat="server" Text="Email :" Theme="DevEx">
                                           </dx:ASPxLabel>
                                       </td>
                                       <td>
                                           <dx:ASPxTextBox ID="txtemail" runat="server" Theme="DevEx" Width="170px">
                                           </dx:ASPxTextBox>
                                       </td>
                                       <td>
                                       ...
                                       <td style="height:20px;width:150px;text-align:right;">&nbsp;</td>
                                       <td colspan="3">&nbsp;</td>
                                   </tr>
                                   <tr>
                                       <td></td>
                                   ...
                                   <tr>
                                       <td>
                                           <dx:ASPxLabel ID="ASPxLabel10" runat="server" Text="Acadamic Info" Theme="DevEx">
                                           </dx:ASPxLabel>
                                       </td>
                                   </tr>
                                   <tr>
                                   ...
                                   <tr>
                                       <td style="height:20px;width:150px;text-align:right;">
                                           <dx:ASPxLabel ID="ASPxLabel11" runat="server" Text="Qualification :" Theme="DevEx">
                                           </dx:ASPxLabel>
                                       </td>
                                       <td>
                                           <dx:ASPxTextBox ID="txtqualification" runat="server" Theme="DevEx" Width="170px">
                                           </dx:ASPxTextBox>
                                       </td>
                                       <td>
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtqualification" ErrorMessage="*" Font-Size="Large" ForeColor="Red"></asp:RequiredFieldValidator>
                                       </td>
                                       <td style="height:20px;width:150px;text-align:right;">
                                           <dx:ASPxLabel ID="ASPxLabel19" runat="server" Text="Specialization :" Theme="DevEx">
                                           </dx:ASPxLabel>
                                       </td>
                                       <td>
                                           <dx:ASPxTextBox ID="txtspecialization" runat="server" Theme="DevEx" Width="170px">
                                           </dx:ASPxTextBox>
                                       </td>
                                       <td>&nbsp;</td>
                                       <td>
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtspecialization" ErrorMessage="*" Font-Size="Large" ForeColor="Red"></asp:RequiredFieldValidator>
                                       </td>
                                   </tr>
                                   <tr>
                                       <td style="height:20px;width:150px;text-align:right;">
                                           <dx:ASPxLabel ID="ASPxLabel13" runat="server" Text="About :" Theme="DevEx">
                                           </dx:ASPxLabel>
                                       </td>
                                       <td>
                                           <dx:ASPxTextBox ID="txtabout" runat="server" Theme="DevEx" Width="170px">
                                           </dx:ASPxTextBox>
                                       </td>
                                       <td>
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtabout" ErrorMessage="*" Font-Size="Large" ForeColor="Red"></asp:RequiredFieldValidator>
                                       </td>
                                       <td></td>
                                       <td colspan="3"></td>
                                   </tr>
                       ...
                       <table>
                           <tr>
                               ...
                               <td style="width:65px">
                                   <dx:ASPxButton ID="BtnNew" runat="server" Text="New" Theme="DevEx" CausesValidation="False" OnClick="BtnNew_Click"></dx:ASPxButton>
                                   </td>
                               <td style="width:65px">
                                   <dx:ASPxButton ID="BtnClear" runat="server" Text="Clear" Theme="DevEx" CausesValidation="False" OnClick="BtnClear_Click"></dx:ASPxButton>
                                   </td>
                               <td style="width:272px">
                                   </td>
                               </tr>
