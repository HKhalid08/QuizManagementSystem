<%@ Page Language="C#" AutoEventWireup="true" CodeFile="norights.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
    ...
    <ContentTemplate>
                       <table class="insert-form">
                           <tbody style="margin:0px;">
                               <tr>
                                   <td style="width:700px;font-size:65px;color:red;text-align:center;">
