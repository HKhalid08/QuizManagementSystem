<%@ Page Language="C#" AutoEventWireup="true" CodeFile="notifications.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                ...
                <table cellspacing="0" >
                   ...
                   <div class="Contents_Proper_Div">
                    <div class="Contents_Link_View">
                           ...
                           <a class="Contents_Link_Anchor" href="viewnotifications.aspx" style="text-decoration:none" id="View_Tooltip" tooltip="View Notifications Here">&nbsp;&nbsp;&nbsp;<strong>View Notifications</strong></a>
                       ...
                       <div class="Contents_Link_New">
                           ...
                           <a class="Contents_Link_Anchor" href="addnotifications.aspx" style="text-decoration:none" id="New_Tooltip" tooltip="Add Notifications Here">&nbsp;&nbsp;&nbsp;<strong>Add Notifications</strong></a>
