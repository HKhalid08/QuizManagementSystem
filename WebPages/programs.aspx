<%@ Page Language="C#" AutoEventWireup="true" CodeFile="programs.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
    ...
    <ContentTemplate>
                           ...
                           <tbody style="margin:0px;">
                               ...
                               <tr style="margin-top:-10px;padding-top:-10px">
                                   <td colspan:4 style="padding:0px 0px 0px 0px; margin:0px 0px 0px 0px">
                                       ...
                                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Programs :" Theme="DevEx">
                                       </dx:ASPxLabel>
                               ...
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                        <dx:ASPxLabel ID="lblEmployeeCodebel" runat="server" Text="Program ID :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3">
                                        <dx:ASPxTextBox ID="txtprogramid" runat="server" Theme="DevEx" Width="170px">
                                   ...
                                   <td class="auto-style3">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtprogramid" ErrorMessage="Enter Program ID" ForeColor="Red"></asp:RequiredFieldValidator>
                                   </td>
                                   <td class="auto-style3">
                                        &nbsp;</td>
                               </tr>
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;" rowspan="2">
                                        <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Program Name :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3" rowspan="2">
                                        <dx:ASPxTextBox ID="txtprogramname" runat="server" Width="170px" Theme="DevEx">
                                            <ValidationSettings CausesValidation="True" ErrorDisplayMode="ImageWithTooltip" ValidationGroup="validate_group">
                                                <RequiredField ErrorText="" IsRequired="True" />
                                            </ValidationSettings>
                                        </dx:ASPxTextBox>
                                   ...
                                   <td class="auto-style3">
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtprogramname" ErrorMessage="Enter Alpahbatics Only" ForeColor="Red" ValidationExpression="^[a-zA-Z ]*$"></asp:RegularExpressionValidator>
                                   </td>
                                   <td class="auto-style3" rowspan="2">
                                        &nbsp;</td>
                               </tr>
                               <tr>
                                   <td class="auto-style3">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtprogramname" ErrorMessage="Enter Program Name" ForeColor="Red"></asp:RequiredFieldValidator>
                                   </td>
                               </tr>
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;" rowspan="2">
                                        <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Total Credit Hours :" Theme="DevEx"></dx:ASPxLabel>
                                   </td>
                                   <td class="auto-style3" rowspan="2">
                               ...
                               <tr>
                                   <td class="auto-style3">
                                       <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtcredithours" ErrorMessage="Enter Credit Hours" ForeColor="Red"></asp:RequiredFieldValidator>
                                   </td>
                               </tr>
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                       ...
                       <table>
                           <tr>
                               ...
                               <td style="width:65px">
                                   <dx:ASPxButton ID="BtnNew" runat="server" Text="New" Theme="DevEx" OnClick="BtnNew_Click" CausesValidation="False"></dx:ASPxButton>
                                   </td>
                               <td style="width:65px">
