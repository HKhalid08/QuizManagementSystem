<%@ Page Language="C#" AutoEventWireup="true" CodeFile="schedule.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                ...
                <table cellspacing="0" >
                   ...
                   <div class="Contents_Proper_Div">
                     <div class="Contents_Link_View">
                           ...
                           <a class="Contents_Link_Anchor" href="viewschedule.aspx" style="text-decoration:none" id="View_Tooltip" tooltip="View Schedule Here">&nbsp;&nbsp;&nbsp;<strong>View Schedule</strong></a>
                       ...
                       <div class="Contents_Link_New">
                           ...
                           <a class="Contents_Link_Anchor" href="addschedule.aspx" style="text-decoration:none" id="New_Tooltip" tooltip="Add Schedule Here">&nbsp;&nbsp;&nbsp;<strong>Add Schedule</strong></a>
