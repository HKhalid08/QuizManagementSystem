<%@ Page Language="C#" AutoEventWireup="true" CodeFile="studentenroll.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
            ...
            <td>
                ...
                <div class="User_Profile_Box" id="Profile_Box_layout">
                    ...
                    <div style="margin-top:10px;margin-bottom:10px;">
                           ...
                           <asp:LinkButton ID="linkChangePassword" runat="server" Font-Names="Arial" Font-Size="12px" ForeColor="gray" CssClass="ChnagePassword_Link" CausesValidation="false" ToolTip="Change Password" OnClick="linkChangePassword_Click">Change Password</asp:LinkButton>
                           ...
                           <tbody style="margin:0px;">
                               ...
                               <tr style="margin-top:-10px;padding-top:-10px">
                                   <td colspan:4 style="padding:0px 0px 0px 0px; margin:0px 0px 0px 0px">
                                       ...
                                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Student Enrollment :" Theme="DevEx">
                                       </dx:ASPxLabel>
                               ...
                               <tr>
                                   ...
                                   <td class="auto-style3">
                                       <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                              <ContentTemplate>
                                        <dx:ASPxComboBox ID="cbrollno" runat="server" Theme="DevEx" ValueType="System.String" NullText="--Select--" OnSelectedIndexChanged="cbrollno_SelectedIndexChanged" AutoPostBack="True">
                                        </dx:ASPxComboBox>
                                                  </ContentTemplate>
                                          </asp:UpdatePanel>
                                   </td>
                               ...
                               <tr>
                                   ...
                                   <td class="auto-style3">
                                       <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                            <ContentTemplate>
                                        <dx:ASPxTextBox ID="txtname" runat="server" Width="170px" AutoPostBack="True">
                                        </dx:ASPxTextBox>
                                                </ContentTemplate>
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="cbrollno" EventName="SelectedIndexChanged" />
                                            </Triggers>
                                        </asp:UpdatePanel>
                                   </td>
                               </tr>
                               <tr>
                                   ...
                                   <td class="auto-style3">
                                        <dx:ASPxComboBox ID="cmbsession" runat="server" ValueType="System.String" Theme="DevEx" NullText="--Select--"></dx:ASPxComboBox>
                                   </td>
                               </tr>
                               <tr>
                                   <td style="height:20px;width:150px;text-align:right;">
                                ...
                                <tr>
                                   <td rowspan="3">
                                    ...
                                    <td rowspan="3" class="auto-style3">
                                        ...
                                        <dx:ASPxListBox ID="lbcourses" runat="server" Height="260px" Theme="DevEx" ValueType="System.String" Width="220px">
                                        </dx:ASPxListBox>
                                        
                                   </td>
                                     <td class="auto-style4">
                                        
                                         <dx:ASPxButton ID="BtnRight" runat="server" Text="&gt;&gt;" Theme="DevEx" Width="10px" CausesValidation="false" OnClick="BtnRight_Click1" Height="23px">
                                         </dx:ASPxButton>
                                        
                                   </td>
                                     <td rowspan="3" align="left" class="auto-style5">
                                         <dx:ASPxListBox ID="lbassigncourses" runat="server" Height="260px" Theme="DevEx" ValueType="System.String" Width="220px">
                                         </dx:ASPxListBox>
                                    </td>
                               </tr>
                                ...
                                <tr>
                                     <td>
                                         ...
                                         <dx:ASPxButton ID="BtnLeft" runat="server" Text="&lt;&lt;" Theme="DevEx" Width="10px" CausesValidation="false" OnClick="BtnLeft_Click1">
                                         </dx:ASPxButton>
                       ...
                       <table>
                           <tr>
                               ...
                               <td style="width:65px">
                                   &nbsp;</td>
                               <td style="width:272px">
                                   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="lbassigncourses" ErrorMessage="Select Courses From List" ForeColor="Red" InitialValue="1"></asp:RequiredFieldValidator>
                               </td>
                               </tr>
                           <tr>
                               <td style="width:272px">
                           ...
                           <tr>
                               ...
                               <td style="width:65px">
                                   <dx:ASPxButton ID="BtnNew" runat="server" OnClick="BtnNew_Click" Text="New" Theme="DevEx">
                                   </dx:ASPxButton>
                               </td>
                               <td style="width:65px">
                                   <dx:ASPxButton ID="BtnClear" runat="server" OnClick="BtnClear_Click" Text="Clear" Theme="DevEx">
                                   </dx:ASPxButton>
                               </td>
                               <td style="width:272px"></td>
                           </tr>
