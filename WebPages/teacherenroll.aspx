<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teacherenroll.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                           ...
                           <tbody style="margin:0px;">
                               ...
                               <tr style="margin-top:-10px;padding-top:-10px">
                                   <td colspan:4 style="padding:0px 0px 0px 0px; margin:0px 0px 0px 0px">
                                       ...
                                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Teacher Enrollment :" Theme="DevEx">
                                       </dx:ASPxLabel>
                               ...
                               <tr>
                                   ...
                                   <td class="auto-style3">
                                          <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                              <ContentTemplate>
                                                  <dx:ASPxComboBox ID="cbemployeecode" runat="server" NullText="--Select--" OnSelectedIndexChanged="cbemployeecode_SelectedIndexChanged" Theme="DevEx" ValueType="System.String" AutoPostBack="True">
                                                  </dx:ASPxComboBox>
                                              </ContentTemplate>
                                          </asp:UpdatePanel>
                               ...
                               <tr>
                                   ...
                                   <td class="auto-style3">
                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                            <ContentTemplate>
                                                <dx:ASPxTextBox ID="txtname" runat="server" Theme="DevEx" Width="170px" AutoPostBack="True">
                                                </dx:ASPxTextBox>
                                            </ContentTemplate>
                                            <Triggers>
                               ...
                               <tr>
                                   ...
                                   <td rowspan="2">
                                    ...
                                    <td rowspan="2" class="auto-style3">
                                     ...
                                     <td class="auto-style4">
                                         ...
                                         <dx:ASPxButton ID="BtnRight" runat="server" Text="&gt;&gt;" Theme="DevEx" Width="10px" CausesValidation="false" OnClick="BtnRight_Click">
                                         </dx:ASPxButton>
                                        
                                   </td>
                                     <td rowspan="2" align="left" class="auto-style5">
                                ...
                                <tr>
                                     <td>
                                         ...
                                         <dx:ASPxButton ID="BtnLeft" runat="server" Text="&lt;&lt;" Theme="DevEx" Width="10px" CausesValidation="false" OnClick="BtnLeft_Click">
                                         </dx:ASPxButton>
