<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userrights.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                   ...
                   <div class="Contents_Proper_Div">
                       <div class="Contents_Link_View">
                        <div class="Contents_Link_View_Icon">
                           ...
                           <a class="Contents_Link_Anchor" href="viewuserrights.aspx" style="text-decoration:none" id="View_Tooltip" tooltip="View User Rights Here">&nbsp;&nbsp;&nbsp;<strong>View User Rights</strong></a>
                       ...
                       <div class="Contents_Link_New">
                           ...
                           <a class="Contents_Link_Anchor" href="adduserrights.aspx" style="text-decoration:none" id="New_Tooltip" tooltip="Add User Rights Here">&nbsp;&nbsp;&nbsp;<strong>Add User Rights</strong></a>
