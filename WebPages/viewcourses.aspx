<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewcourses.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                       ...
                       <table class="insert-form">
                          <tbody style="margin:0px;">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                               <ContentTemplate>
                                <asp:GridView ID="dgcourses" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="cetegory" HeaderText="Cetegory" />
                                        <asp:TemplateField HeaderText="Detail">
                                        <ItemTemplate>
                                        <asp:LinkButton ID="btnupdate" CommandArgument='<%#Eval("course_code")%>' OnClick="btnupdate_Click" CausesValidation="false" runat="server">Update</asp:LinkButton>                  
                                        </ItemTemplate>

                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                        <asp:LinkButton ID="btndelete" CommandArgument='<%#Eval("course_code")%>' OnClick="btndelete_Click" CausesValidation="false" runat="server">Delete</asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
