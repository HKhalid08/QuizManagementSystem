<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewdesignation.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                         ...
                         <table class="insert-form">
                          <tbody style="margin:0px;">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                               <ContentTemplate>
                                <asp:GridView ID="dgdesignation" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="des_id" HeaderText="Designation ID" />
                                        <asp:BoundField DataField="des_name" HeaderText="Designation Name" />
                                        <asp:TemplateField HeaderText="Detail">
                                        <ItemTemplate>
                                        <asp:LinkButton ID="btnupdate" CommandArgument='<%#Eval("des_id")%>' OnClick="btnupdate_Click" CausesValidation="false" runat="server">Update</asp:LinkButton>                  
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                        <asp:LinkButton ID="btndelete" CommandArgument='<%#Eval("des_id")%>' OnClick="btndelete_Click" CausesValidation="false" runat="server">Delete</asp:LinkButton>
