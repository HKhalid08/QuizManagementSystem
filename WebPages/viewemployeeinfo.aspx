<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewemployeeinfo.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                   ...
                   <div class="Contents_Proper_Div" style="overflow:scroll;">
                        ...
                        <table class="insert-form">
                          ...
                          <tbody style="margin:0px;">
                                  ...
                                  <td>
                                       ...
                                       <tr style="background-color:#808080;height:40px;">
                                                        <td style="width:100px;padding-left:10px;text-align:center;">
                                                           <asp:Label ID="Label25" runat="server" Text="Employee Code"></asp:Label>
                                                        </td>
                                                        ...
                                                        <td style="width:50px;padding-left:10px;text-align:center;">
                                                           <asp:Label ID="Label28" runat="server" Text="Gender"></asp:Label>
                                                        </td>
                                                        <td style="width:150px;padding-left:10px;text-align:center;">
                                                           <asp:Label ID="Label29" runat="server" Text='Mobile'></asp:Label>
                                                        </td>
                                                        <td style="text-align:center;">
                                                            <asp:Label ID="Label30" runat="server" Text='Details'></asp:Label>
                                                             </td>
                                                    </tr>
                                  </table>
                                  </td>
                            ...
                            <asp:GridView ID="dgteacherinfo" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333" ShowHeader="False">
                                    ...
                                    <Columns>                                           
                                                ...
                                                <table style="width:740px;" cellspacing="0">
                                                   <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:150px;padding-left:10px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text='<%#Eval("Father_name")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:50px;padding-left:10px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text='<%#Eval("Gender")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:150px;padding-left:10px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text='<%#Eval("Mobile")%>' Theme="DevEx"></dx:ASPxLabel>
                                                    ...
                                                    <tr style="background-color:#f6f5f5;width:740px;">
                                                        ...
                                                        <td style="width:120px;height:30px;padding-left:10px;">
                                                            <dx:ASPxLabel ID="ASPxLabel22" runat="server" Text="Department :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:120px;">
                                                            <dx:ASPxLabel ID="ASPxLabel13" runat="server" Text='<%#Eval("Dep_id")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:100px;">
                                                            <dx:ASPxLabel ID="ASPxLabel16" runat="server" Text="Designation ID:" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:100px;">
                                                            <dx:ASPxLabel ID="ASPxLabel14" runat="server" Text='<%#Eval("Des_id")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:95px;">
                                                            <dx:ASPxLabel ID="ASPxLabel17" runat="server" Text="Qualification :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td>
                                                            <dx:ASPxLabel ID="ASPxLabel15" runat="server" Text='<%#Eval("Qualification")%>' Theme="DevEx"></dx:ASPxLabel>
                                                            ...
                                                            <tr>
                                                             <td style="width:120px;height:30px;padding-left:10px;">
                                                                 <dx:ASPxLabel ID="ASPxLabel18" runat="server" Text="Date of Birth :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:120px;">
                                                            <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text='<%#Eval("Dob","{0:d}")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:100px;">
                                                            <dx:ASPxLabel ID="ASPxLabel19" runat="server" Text="CNIC :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:100px;">
                                                            <dx:ASPxLabel ID="ASPxLabel7" runat="server" Text='<%#Eval("Nic")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:95px;">
                                                            <dx:ASPxLabel ID="ASPxLabel20" runat="server" Text="Nationality :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td>
                                                            <dx:ASPxLabel ID="ASPxLabel8" runat="server" Text='<%#Eval("Nationality")%>' Theme="DevEx"></dx:ASPxLabel>
                                                            ...
                                                            <tr>
                                                                <td style="width:120px;height:30px;padding-left:10px;">
                                                                    <dx:ASPxLabel ID="ASPxLabel21" runat="server" Text="Contact No :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:120px;">
                                                            <dx:ASPxLabel ID="ASPxLabel9" runat="server" Text='<%#Eval("phone")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:100px;">
                                                            <dx:ASPxLabel ID="ASPxLabel23" runat="server" Text="Email :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:100px;">
                                                            <dx:ASPxLabel ID="ASPxLabel10" runat="server" Text='<%#Eval("Email")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:95px;">
                                                            <dx:ASPxLabel ID="ASPxLabel24" runat="server" Text="Permanent Address :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td>
                                                            <dx:ASPxLabel ID="ASPxLabel11" runat="server" Text='<%#Eval("p_address")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                            </tr>
                                                            <tr>
                                                                 <td style="width:150px;height:30px;padding-left:10px;">
                                                                     <dx:ASPxLabel ID="ASPxLabel25" runat="server" Text="Joining Date :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:150px;" colspan="5">
                                                            <dx:ASPxLabel ID="ASPxLabel12" runat="server" Text='<%#Eval("Joining_date","{0:d}")%>' Theme="DevEx"></dx:ASPxLabel>
                                        ...
                                        <ItemTemplate>
                                        <asp:LinkButton ID="btnupdate" CommandArgument='<%#Eval("Emp_code")%>' OnClick="btnupdate_Click" CausesValidation="false" runat="server">Update</asp:LinkButton>                  
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                        <asp:LinkButton ID="btndelete" CommandArgument='<%#Eval("Emp_code")%>' OnClick="btndelete_Click" CausesValidation="false" runat="server">Delete</asp:LinkButton>
