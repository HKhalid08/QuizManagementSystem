<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewnotice.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                          ...
                          <tbody style="margin:0px;">
                              <tr>
                                  <td>
                                       ...
                                       <tr style="background-color:#808080;height:40px;">
                                                        <td style="padding-left:120px;" class="auto-style3">
                            ...
                            <asp:GridView ID="dgnotice" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333" ShowHeader="False">
                                    ...
                                    <Columns>                                           
                                        ...
                                        <ItemTemplate>
                                        <asp:LinkButton ID="btnupdate" CommandArgument='<%#Eval("notice_id")%>' OnClick="btnupdate_Click1" CausesValidation="false" runat="server">Update</asp:LinkButton>                  
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                        <asp:LinkButton ID="btndelete" CommandArgument='<%#Eval("notice_id")%>' OnClick="btndelete_Click1" CausesValidation="false" runat="server">Delete</asp:LinkButton>
