<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewnotifications.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                   ...
                   <div class="Contents_Proper_Div" style="overflow:scroll;">
                       <table class="insert-form">
                          ...
                          <tbody style="margin:0px;">
                              <tr>
                                  <td>
                                       ...
                                       <tr style="background-color:#808080;height:40px;">
                                                        <td style="width:30px;padding-left:10px;text-align:center;">
                            ...
                            <asp:GridView ID="dgnotification" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333" ShowHeader="False">
