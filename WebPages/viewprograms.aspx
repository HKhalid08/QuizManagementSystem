<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewprograms.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
            ...
            <td>
                ...
                <div class="User_Profile_Box" id="Profile_Box_layout">
                       <div class="User_Profile_Box_Profile_Link_Div">
                           ...
                           <asp:LinkButton ID="linkProfile" runat="server" CssClass="Profile-Box" Font-Names="arial" Font-Size="12px" ForeColor="gray" ToolTip="Profile" OnClick="linkProfile_Click1">Profile</asp:LinkButton>
                         ...
                         <table class="insert-form">
                          <tbody style="margin:0px;">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                               <ContentTemplate>
                                <asp:GridView ID="dgprogram" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333" PageSize="15">
                                    ...
                                    <Columns>
                                        ...
                                        <ItemTemplate>
                                        <asp:LinkButton ID="btnupdate" CommandArgument='<%#Eval("program_id")%>' OnClick="btnupdate_Click" CausesValidation="false" runat="server">Update</asp:LinkButton>                  
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                        <asp:LinkButton ID="btndelete" CommandArgument='<%#Eval("program_id")%>' OnClick="btndelete_Click" CausesValidation="false" runat="server">Delete</asp:LinkButton>
