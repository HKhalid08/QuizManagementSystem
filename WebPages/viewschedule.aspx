<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewschedule.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                        ...
                        <table class="insert-form">
                          <tbody style="margin:0px;">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                               <ContentTemplate>
                                <asp:GridView ID="dgschedule" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="session_id" HeaderText="Session" />
                                        ...
                                        <asp:BoundField DataField="time_from" HeaderText="Time From" DataFormatString="{0:T}" HtmlEncode="false" />
                                        <asp:BoundField DataField="time_to" HeaderText="Time To" DataFormatString="{0:T}" />
