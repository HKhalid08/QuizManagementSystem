<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewsession.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                        ...
                        <table class="insert-form">
                          <tbody style="margin:0px;">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                               <ContentTemplate>
                                <asp:GridView ID="dgsession" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333">
                                    ...
                                    <Columns>
                                        ...
                                        <ItemTemplate>
                                        <asp:LinkButton ID="btnupdate" CommandArgument='<%#Eval("session_id")%>' OnClick="btnupdate_Click" CausesValidation="false" runat="server">Update</asp:LinkButton>                  
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                        <asp:LinkButton ID="btndelete" CommandArgument='<%#Eval("session_id")%>' OnClick="btndelete_Click" CausesValidation="false" runat="server">Delete</asp:LinkButton>
