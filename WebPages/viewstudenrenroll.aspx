<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewstudenrenroll.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                ...
                <table cellspacing="0" >
                   ...
                   <table class="insert-form">
                          ...
                          <tbody style="margin:0px;">
                                  ...
                                  <td>
                                       ...
                                       <tr style="background-color:#808080;height:40px;">
                                                        <td style="text-align:center;" class="auto-style3">
                                                            <dx:ASPxLabel ID="ASPxLabel16" runat="server" Text="Roll No" Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="padding-left:40px;text-align:left;" class="auto-style4">
                            ...
                            <asp:GridView ID="dgstudentenroll" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333" ShowHeader="False">
                                                   ...
                                                   <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:center;">
                                                           <input type="button" value="View" title=<%#Eval("rollno") %> />
                                                        </td>
                                                    ...
                                                    <tr style="background-color:#f6f5f5;width:740px;">
                                                        ...
                                                        <table class='<%#Eval("rollno")%>' hidden>
                                                            <tr>
                                                        ...
                                                        <td style="width:700px;height:30px;padding-left:10px;">
                                                          <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text='<%#Eval("id")%>' Theme="DevEx"></dx:ASPxLabel>  
