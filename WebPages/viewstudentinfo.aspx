<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewstudentinfo.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                   ...
                   <div class="Contents_Proper_Div" style="overflow:scroll">
                      <table class="insert-form">
                          ...
                          <tbody style="margin:0px;">
                            ...
                            <asp:GridView ID="dgstudentinfo" runat="server" AllowPaging="True" AutoGenerateColumns="False" GridLines="None" CellPadding="4" ForeColor="#333333" ShowHeader="False">
                                    ...
                                    <Columns>                                           
                                                   ...
                                                   <tr>
                                                    ...
                                                    <tr style="background-color:#f6f5f5;width:740px;">
                                                        ...
                                                        <td style="width:120px;height:30px;padding-left:10px;">
                                                            <dx:ASPxLabel ID="ASPxLabel22" runat="server" Text="Program :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:120px;">
                                                            <dx:ASPxLabel ID="ASPxLabel13" runat="server" Text='<%#Eval("program_id")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:100px;">
                                                            <dx:ASPxLabel ID="ASPxLabel16" runat="server" Text="Session :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:100px;">
                                                            <dx:ASPxLabel ID="ASPxLabel14" runat="server" Text='<%#Eval("session_id")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:95px;">
                                                            <dx:ASPxLabel ID="ASPxLabel17" runat="server" Text="Date of Birth :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td>
                                                            <dx:ASPxLabel ID="ASPxLabel15" runat="server" Text='<%#Eval("dob","{0:d}")%>' Theme="DevEx"></dx:ASPxLabel>
                                                            ...
                                                            <tr>
                                                             <td style="width:120px;height:30px;padding-left:10px;">
                                                                 <dx:ASPxLabel ID="ASPxLabel18" runat="server" Text="CNIC :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:120px;">
                                                            <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text='<%#Eval("nic")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:100px;">
                                                            <dx:ASPxLabel ID="ASPxLabel19" runat="server" Text="Nationality :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:100px;">
                                                            <dx:ASPxLabel ID="ASPxLabel7" runat="server" Text='<%#Eval("nationality")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:95px;">
                                                            <dx:ASPxLabel ID="ASPxLabel20" runat="server" Text="Phone No :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td>
                                                            <dx:ASPxLabel ID="ASPxLabel8" runat="server" Text='<%#Eval("phone")%>' Theme="DevEx"></dx:ASPxLabel>
                                                            ...
                                                            <tr>
                                                                <td style="width:120px;height:30px;padding-left:10px;">
                                                                    <dx:ASPxLabel ID="ASPxLabel21" runat="server" Text="Current Address :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:120px;">
                                                            <dx:ASPxLabel ID="ASPxLabel9" runat="server" Text='<%#Eval("c_address")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:100px;">
                                                            <dx:ASPxLabel ID="ASPxLabel23" runat="server" Text="Permanent Address :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:100px;">
                                                            <dx:ASPxLabel ID="ASPxLabel10" runat="server" Text='<%#Eval("p_address")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                        <td style="width:95px;">
                                                            <dx:ASPxLabel ID="ASPxLabel24" runat="server" Text="Email :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td>
                                                            <dx:ASPxLabel ID="ASPxLabel11" runat="server" Text='<%#Eval("email")%>' Theme="DevEx"></dx:ASPxLabel>
                                                           
                                                        </td>
                                                            </tr>
                                                            <tr>
                                                                 <td style="width:150px;height:30px;padding-left:10px;">
                                                                     <dx:ASPxLabel ID="ASPxLabel25" runat="server" Text="Registration Date :" Theme="DevEx" Font-Bold="True"></dx:ASPxLabel>
                                                            
                                                        </td>
                                                        <td style="width:150px;" colspan="5">
                                                            <dx:ASPxLabel ID="ASPxLabel12" runat="server" Text='<%#Eval("reg_date","{0:d}")%>' Theme="DevEx"></dx:ASPxLabel>
                                      ...
                                      <asp:TemplateField HeaderText="Detail">
                                        <ItemTemplate>
                                        <asp:LinkButton ID="btnupdate" CommandArgument='<%#Eval("rollno")%>' OnClick="btnupdate_Click" CausesValidation="false" runat="server">Update</asp:LinkButton>                  
                                        ...
                                        <asp:TemplateField HeaderText="Delete">
                                            <ItemTemplate>
                                        <asp:LinkButton ID="btndelete" CommandArgument='<%#Eval("rollno")%>' OnClick="btndelete_Click" CausesValidation="false" runat="server">Delete</asp:LinkButton>
