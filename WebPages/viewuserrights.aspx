<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewuserrights.aspx.cs" Inherits="Web_Pages_PortoQuiz_Home" %>
                                       ...
                                       <tr style="background-color:#808080;height:40px;">
                                                        ...
                                                        <td style="padding-left:20px;" class="auto-style4">
                                                         ...
                                                         <td style="padding-left:35px;text-align:left;">
                                                            <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text="Designation" Theme="DevEx"></dx:ASPxLabel>
                                                ...
                                                <table style="width:740px;" cellspacing="0">
                                                   <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:350px;padding-left:10px;text-align:center;">
                                                            <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text='<%#Eval("des_id")%>' Theme="DevEx"></dx:ASPxLabel>
